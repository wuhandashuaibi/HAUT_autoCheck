...
def checkIn(userInfo,token):
    ...
    jsons={
            ...
            "areaStr": {"streetNumber":"30号","street":"莲花街","district":"中原区","city":"郑州市","province":"河南省","town":"","pois":"翰林国际城孔园","lng":113.55064699999795 + random.random()/1000,"lat":34.83870696238093 + random.random()/1000,"address":"中原区长椿路辅路河南工业大学(莲花街校区)","text":"河南省-郑州市","code":""},
